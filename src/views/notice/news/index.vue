<template>
	...
	<el-card>
		...
		>
			...
			<ma-image-column prop="cover" label="图片" header-align="center" align="center"></ma-image-column>
			<el-table-column prop="tenantId" label="租户id" header-align="center" align="center"></el-table-column>
			<el-table-column label="操作" fixed="right" header-align="center" align="center" width="150">
				<template #default="scope">
					<el-button v-auth="'notice:news:update'" type="primary" link @click="addOrUpdateHandle(scope.row.id)">修改</el-button>
					<el-button v-auth="'notice:news:delete'" type="primary" link @click="deleteBatchHandle(scope.row.id)">删除</el-button>
				</template>
			</el-table-column>
		</el-table>
		<el-pagination
...
<script setup lang="ts" name="NoticeNewsIndex">
